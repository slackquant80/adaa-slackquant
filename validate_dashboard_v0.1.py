...
for token in ['"historical_2023_rank":735','"total_five_rule_sets":4368','"decision_months":216','"performance_months":218','"paper_version":"v1.15 FINAL"']:
...
print('checks:', 7+sum(1 for _ in csv.DictReader(open(root/'DATA_MANIFEST_SHA256.csv',encoding='utf-8'))) + 5 + 3 + 6)
