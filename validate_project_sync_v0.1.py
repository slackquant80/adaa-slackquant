...
for req in ['index.html','assets/css/style.css','assets/js/data.js','assets/js/app.js','DATA_MANIFEST_SHA256.csv','downloads/ADAA_SSRN_Working_Paper_v1.15_FINAL.pdf','downloads/ADAA_Public_Replication_Package_v1.0.zip']:
    checks+=1
...
for token in ['"historical_2023_rank":735','"total_five_rule_sets":4368','"decision_months":216','"performance_months":218','"historical_2023_score":0.8171374401867475','"paper_version":"v1.15 FINAL"']:
    checks+=1
...
if project and project.name=='05_ADAA':
    canon_paper=project/'05_Practical_Paper/01_Manuscript/ADAA_SSRN_Working_Paper_v1.15_FINAL.pdf'
    canon_repl=project/'06_Replication/ADAA_Public_Replication_Package_v1.0.zip'
    for canon,copy,label in [(canon_paper,dash/'downloads/ADAA_SSRN_Working_Paper_v1.15_FINAL.pdf','paper'),(canon_repl,dash/'downloads/ADAA_Public_Replication_Package_v1.0.zip','replication')]:
        checks+=1
